    ...
    schemas: {
      ...
      MonitoredItem: {
        ...
        properties: {
          ...
          status: { type: "string", enum: ["up_to_date", "outdated", "end_of_life"] },
          securityState: { type: "string", enum: ["vulnerable", "no_known_vuln"] },
          monitoringEnabled: { type: "boolean" },
          lastChecked: { type: "string", format: "date-time", nullable: true },
          assetCriticality: { type: "integer", minimum: 0, maximum: 5, nullable: true },
          environment: { type: "string", enum: ["prod", "preprod", "dev", "test"], nullable: true },
          networkExposure: { type: "string", enum: ["internet", "intranet", "isolated"], nullable: true },
          hostsSensitiveData: { type: "boolean", nullable: true },
          hasPrivilegedAccess: { type: "boolean", nullable: true },
          hasCompensatingControls: { type: "boolean", nullable: true },
          userNote: { type: "string", maxLength: 30, nullable: true },
          externalScore: { type: "number", nullable: true, description: "Normalized external severity score (0-100)" },
          externalSeverity: { type: "string", enum: ["low", "medium", "high", "critical"], nullable: true },
          externalVector: { type: "string", nullable: true },
          externalSource: { type: "string", nullable: true },
          epssPercent: { type: "number", nullable: true },
          vprScore: { type: "number", nullable: true },
          internalScore: { type: "number", nullable: true, description: "BPT internal score (0-100)" },
          internalSeverity: { type: "string", enum: ["low", "medium", "high", "critical"], nullable: true },
          scoreConfidence: { type: "integer", nullable: true, description: "BPT confidence based on context completion (20-100)" },
          scoreUpdatedAt: { type: "string", format: "date-time", nullable: true },
      ...
      CreateItem: {
        ...
        properties: {
          ...
          sourceId: { type: "string", nullable: true },
          sourceParams: { type: "string", nullable: true },
          status: { type: "string", enum: ["up_to_date", "outdated", "end_of_life"], default: "up_to_date" },
          securityState: { type: "string", enum: ["vulnerable", "no_known_vuln"], default: "no_known_vuln" },
          monitoringEnabled: { type: "boolean" },
          assetCriticality: { type: "integer", minimum: 0, maximum: 5, nullable: true },
          environment: { type: "string", enum: ["prod", "preprod", "dev", "test"], nullable: true },
          networkExposure: { type: "string", enum: ["internet", "intranet", "isolated"], nullable: true },
      ...
      ScheduledReport: {
        ...
        properties: {
          ...
          hour: { type: "integer" },
          filters: { type: "string", description: "JSON string with optional type/status/tags and risk filters (internalSeverities, externalSeverities, cveMin)" },
        ...
        properties: {
          ...
          filters: {
            ...
            properties: {
              ...
              internalSeverities: { type: "array", items: { type: "string", enum: ["low", "medium", "high", "critical"] } },
              externalSeverities: { type: "array", items: { type: "string", enum: ["low", "medium", "high", "critical"] } },
              cveMin: { type: "integer", minimum: 1 },
            },
          },
  ...
  paths: {
    ...
    "/api/items": {
      get: {
        ...
        parameters: [
          { name: "type", in: "query", schema: { type: "string", enum: ["software", "system", "docker", "service", "firmware", "plugin", "library", "database", "network", "mobile_app", "desktop_app", "web_app", "os", "driver", "iot"] }, description: "Filter by type" },
          { name: "status", in: "query", schema: { type: "string", enum: ["up_to_date", "outdated", "end_of_life"] }, description: "Filter by status" },
          { name: "securityState", in: "query", schema: { type: "string", enum: ["vulnerable", "no_known_vuln"] }, description: "Filter by security state" },
          { name: "riskState", in: "query", schema: { type: "string", enum: ["at_risk"] }, description: "Aggregate risk filter (vulnerable or end_of_life)" },
