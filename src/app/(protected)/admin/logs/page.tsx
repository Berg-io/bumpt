...
export default function AdminLogsPage() {
  ...
  }, [filterType, filterAction, search, page, selectedPageSize]);
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <div className="sm:ml-auto">
            <button
              ...
              className="inline-flex h-9 items-center gap-2 rounded-md border border-red-300 dark:border-red-800 bg-red-50 dark:bg-red-950/30 px-3 text-sm font-medium text-red-700 dark:text-red-400 hover:bg-red-100 dark:hover:bg-red-950/50 disabled:opacity-40 disabled:pointer-events-none transition-colors cursor-pointer"
            >
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={handlePurge}
                  disabled={purging}
                  className="inline-flex h-8 items-center gap-2 rounded-md bg-red-600 px-3 text-sm font-medium text-white hover:bg-red-700 disabled:opacity-60 transition-colors cursor-pointer"
                >
