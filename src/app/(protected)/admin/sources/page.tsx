...
import { Plus, Pencil, Trash2, Plug, Lock, Globe, Zap, FileText, AlertTriangle, FlaskConical } from "lucide-react";
import {
  SiDocker,
  SiGithub,
  SiGitlab,
...
const typeIcons: Record<string, React.ReactNode> = {
  ...
  repology: <img src="/icons/repology-logo.svg" alt="Repology" className="h-4 w-4 grayscale opacity-70" loading="lazy" />,
